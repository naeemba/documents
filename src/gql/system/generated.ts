...
export type RegisterMutation = {
  __typename?: "Mutation";
  create_users_item?: { __typename?: "directus_users"; id: string } | null;
};
...
export type AddRoleMutation = {
  __typename?: "Mutation";
  update_users_items: Array<{
    __typename?: "directus_users";
    id: string;
    role?: { __typename?: "directus_roles"; id: string; name: string } | null;
  }>;
};
...
`;
export const Refresh_TokenDocument = gql`
...
export const RegisterDocument = gql`
  mutation register($data: create_directus_users_input!) {
...
export const AddRoleDocument = gql`
  mutation addRole($userIds: [ID]!, $roleId: ID!) {
    update_users_items(ids: $userIds, data: { role: { id: $roleId } }) {
      id
      role {
        id
        name
...
export function getSdk(
  ...
  return {
    ...
    refresh_token(
      variables: Refresh_TokenMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<Refresh_TokenMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Refresh_TokenMutation>(
            Refresh_TokenDocument,
            variables,
